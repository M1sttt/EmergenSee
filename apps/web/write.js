...
const content = `import React, { forwardRef, memo } from 'react';
...
export interface SelectDropdownProps extends Omit<SelectProps<SelectOption, false>, 'onChange' | 'value' | 'options'> {
...
fs.writeFileSync('src/components/common/SelectDropdown/SelectDropdown.tsx', content);
