...
export default function Layout() {
	...
	return (
		<div className={CONSTS.CLASSES.LAYOUT_CONTAINER}>
			{/* Sidebar */}
			<div
				className={`${CONSTS.CLASSES.SIDEBAR_BASE} ${
					isSidebarExpanded ? CONSTS.CLASSES.SIDEBAR_EXPANDED : CONSTS.CLASSES.SIDEBAR_COLLAPSED
				}`}
			>
				<button
					type="button"
				...
				<div className={CONSTS.CLASSES.SIDEBAR_WRAPPER}>
					{/* Logo */}
					<div
						className={`${CONSTS.CLASSES.LOGO_CONTAINER_BASE} ${
							isSidebarExpanded
					...
					>
						<h1
							className={
								isSidebarExpanded ? CONSTS.CLASSES.LOGO_TEXT_EXPANDED : CONSTS.CLASSES.LOGO_TEXT_COLLAPSED
							}
						>
							{isSidebarExpanded ? STRINGS.APP_NAME : STRINGS.APP_INITIAL}
						</h1>
					...
					>
						...
						<button
							...
							className={`${CONSTS.CLASSES.LOGOUT_BTN_BASE} ${
								isSidebarExpanded ? CONSTS.CLASSES.LOGOUT_BTN_EXPANDED : CONSTS.CLASSES.LOGOUT_BTN_COLLAPSED
							}`}
