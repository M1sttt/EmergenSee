...
export const actionRegisterFace = 'Register Face';
export const faceRegistered = 'Face registered successfully.';
export const faceRegistrationError = 'Face registration failed. Please try again.';
export const columnFaceId = 'Face ID';
export const faceRegistered_badge = 'Registered';
export const faceNotRegistered_badge = 'Not registered';
