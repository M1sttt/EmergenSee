...
import { useCameraEventsQuery, useCameraStatusMutation, useCameraUsersQuery } from 'hooks/data/useCameraPageData';
...
const CameraPage: React.FC = () => {
	...
	const handleConfirm = useCallback(
		(card: SuggestionCard) => {
			...
			setConfirmed(prev => [...prev, card.user]);
			setActiveTab('confirmed');
			statusMutation.mutate({ status: ResponderStatus.SAFE, userId: getEntityId(card.user), eventId });
		},
		[eventId, statusMutation],
	);
