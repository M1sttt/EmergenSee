...
export const cameraCode = 'Camera Code';
export const cameraCodePlaceholder = 'CAM-XXXXXX';
export const cameraLoginBtn = 'Camera Login';
export const cameraCodeRequired = 'Camera code is required';
export const cameraLoginFailed = 'Invalid camera code or password.';
export const cameraLoginSuccess = 'Camera station connected.';
export const switchToStaff = 'Staff login';
export const switchToCamera = 'Camera station login';
